var myInterval = null;
var RoundDopeMarker = fabric.util.createClass(fabric.BaseBrush, {
	color: '#000',
	opacity: 0.6,
	width: 30,
	_baseWidth: 5,
	...
	strokes: 1,
	brush: null,
  	brushCol : 'img/RoundDopeMarker.png',

	initialize: function(canvas, opt) {1
		opt = opt || {};
		var context = this;
		this.canvas = canvas;
		...
		// this.image.src = "img/RoundDopeMarker.png";
		// this.image.onload = () => {
		// 	this._imgload = true;
		// };
...
export default RoundDopeMarker;