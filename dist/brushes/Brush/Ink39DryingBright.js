var myInterval = null;
var Ink39DryingBright = fabric.util.createClass(fabric.BaseBrush, {
	color: '#000',
	opacity: 0.6,
	width: 30,
	_baseWidth: 5,
	...
	strokes: 1,
	brush: null,
	brushCol: 'img/Ink39DryingBright.png',
	...
	initialize: function (canvas, opt) {
		...
		// this.image.src = "img/Ink39DryingBright.png";
		// this.image.onload = () => {
		// 	this._imgload = true;
		// };
...
}); // End Ink39DryingBright

export default Ink39DryingBright;