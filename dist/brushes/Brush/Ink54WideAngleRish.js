var myInterval = null;
var Ink54WideAngleRish = fabric.util.createClass(fabric.BaseBrush, {
	color: '#000',
	opacity: 0.6,
	width: 30,
	_baseWidth: 5,
	...
	strokes: 1,
	brush: null,
	brushCol: 'img/Ink54WideAngleRish.png',
	...
	initialize: function (canvas, opt) {
		...
		// this.image.src = "img/Ink54WideAngleRish.png";
		// this.image.onload = () => {
		// 	this._imgload = true;
		// };
...
}); // End Ink54WideAngleRish

export default Ink54WideAngleRish;