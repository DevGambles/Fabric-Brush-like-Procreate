...
import FurBrush 		from 	'./brushes/furBrush.js';
import InkBrush 		from 	'./brushes/incBrush.js';
import LongFurBrush 	from 	'./brushes/longFurBrush.js'
import RibbonBrush 		from 	'./brushes/ribbonBrush.js'
import ShadedBrush 		from 	'./brushes/shadedBrush.js'
import SketchyBrush 	from 	'./brushes/sketchyBrush.js'
import SprayPaintBrush 	from 	'./brushes/sprayPaintBrush.js'
import SquaresBrush 	from 	'./brushes/squaresBrush.js'
import WebBrush 		from 	'./brushes/webBrush.js'

import SauceBrush 		from 	'./brushes/Spray/SauceBrush.js'
import FatNozzle 		from 	'./brushes/Spray/FatNozzle.js'
import QueensBrush 		from 	'./brushes/Spray/QueensBrush.js'
import FellasBrush 		from 	'./brushes/Spray/FellasBrush.js'

import FlamingMarker 		from 	'./brushes/Marker/FlamingMarker.js'
import HandstylerOne 		from 	'./brushes/Marker/HandstylerOne.js'
import RoughMarker 		from 	'./brushes/Marker/RoughMarker.js'
import RoundDopeMarker 		from 	'./brushes/Marker/RoundDopeMarker.js'
import RoundOutliner 		from 	'./brushes/Marker/RoundOutliner.js'

import Grassy 		from 	'./brushes/Roller/Grassy.js'
import GrungyLinen 		from 	'./brushes/Roller/GrungyLinen.js'
import Pandani 		from 	'./brushes/Roller/Pandani.js'
import Tulle 		from 	'./brushes/Roller/Tulle.js'

import Ink17SparklingBlade2 		from 	'./brushes/Brush/Ink17SparklingBlade2.js'
import Ink39DryingBright 		from 	'./brushes/Brush/Ink39DryingBright.js'
import Ink54WideAngleRish 		from 	'./brushes/Brush/Ink54WideAngleRish.js'
import Watercolor 		from 	'./brushes/Brush/Watercolor.js'
import WetAcrylic 		from 	'./brushes/Brush/WetAcrylic.js'

import LightPen 		from 	'./brushes/Graffical/LightPen.js'
import ThreeDimBrush8 		from 	'./brushes/Graffical/ThreeDimBrush8.js'
import Nebula 		from 	'./brushes/Graffical/Nebula.js'
import Swordgrass 		from 	'./brushes/Graffical/Swordgrass.js'
...
fabric.FurBrush = FurBrush;
fabric.SauceBrush = SauceBrush;
fabric.LongFurBrush = LongFurBrush;
fabric.RibbonBrush = RibbonBrush;
fabric.ShadedBrush = ShadedBrush;
fabric.SketchyBrush = SketchyBrush;
fabric.SprayPaintBrush = SprayPaintBrush;
fabric.SquaresBrush = SquaresBrush;
fabric.WebBrush = WebBrush;

fabric.SauceBrush = SauceBrush;
fabric.FatNozzle = FatNozzle;
fabric.QueensBrush = QueensBrush;
fabric.FellasBrush = FellasBrush;

fabric.FlamingMarker = FlamingMarker;
fabric.HandstylerOne = HandstylerOne;
fabric.RoughMarker = RoughMarker;
fabric.RoundDopeMarker = RoundDopeMarker;
fabric.RoundOutliner = RoundOutliner;

fabric.Grassy = Grassy;
fabric.GrungyLinen = GrungyLinen;
fabric.Pandani = Pandani;
fabric.Tulle = Tulle;

fabric.Ink17SparklingBlade2 = Ink17SparklingBlade2;
fabric.Ink39DryingBright = Ink39DryingBright;
fabric.Ink54WideAngleRish = Ink54WideAngleRish;
fabric.Watercolor = Watercolor;
fabric.WetAcrylic = WetAcrylic;

fabric.LightPen = LightPen;
fabric.ThreeDimBrush8 = ThreeDimBrush8;
fabric.Nebula = Nebula;
fabric.Swordgrass = Swordgrass;
